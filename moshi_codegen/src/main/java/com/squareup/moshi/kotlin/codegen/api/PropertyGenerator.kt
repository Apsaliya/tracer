...
internal class PropertyGenerator(
  ...
  fun generateLocalProperty(nullable: Boolean = true): PropertySpec {
    return PropertySpec.builder(localName, target.type.copy(nullable = nullable))
        .mutable(true)
        .apply {
          if (hasConstructorDefault && nullable) {
